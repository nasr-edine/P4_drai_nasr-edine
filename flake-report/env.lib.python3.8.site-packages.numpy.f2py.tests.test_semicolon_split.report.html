...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.8/site-packages/numpy/f2py/tests/test_semicolon_split.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.8.site-packages.numpy.f2py.tests.test_semicolon_split.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.8.site-packages.numpy.f2py.tests.test_semicolon_split.source.html#l7">
