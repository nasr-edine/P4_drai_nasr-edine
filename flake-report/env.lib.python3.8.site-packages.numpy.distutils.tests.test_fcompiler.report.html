...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.8/site-packages/numpy/distutils/tests/test_fcompiler.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.8.site-packages.numpy.distutils.tests.test_fcompiler.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env/lib/python3.8/site-packages/numpy/distutils/tests/test_fcompiler.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.8.site-packages.numpy.distutils.tests.test_fcompiler.source.html#l43">
                  <tt><i>43</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
