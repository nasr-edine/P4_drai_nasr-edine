...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.8/site-packages/numpy/distutils/tests/test_fcompiler_nagfor.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.8.site-packages.numpy.distutils.tests.test_fcompiler_nagfor.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.8.site-packages.numpy.distutils.tests.test_fcompiler_nagfor.source.html#l17">
