...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.8/site-packages/numpy/core/tests/test__exceptions.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.8.site-packages.numpy.core.tests.test__exceptions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.8.site-packages.numpy.core.tests.test__exceptions.source.html#l12">
